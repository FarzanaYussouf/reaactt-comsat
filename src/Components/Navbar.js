...
<div className="row text-center mt-5">
        <div className="col-12">
            ...
            <p className="mt-4 text-white fs-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas qui eveniet cum, ullam aspernatur tempora perferendis, sint voluptatibus consequuntur dolor ratione id dolorum. Totam, ipsam.</p>
